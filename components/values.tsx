  ...
  return (
    <section id="value" className="border-t border-ink-line bg-ink-soft/40">
      <div className="mx-auto max-w-6xl px-5 py-24 sm:py-32">
        <Reveal>
          <p className="font-mono text-xs tracking-[0.25em] text-paper-faint">WHY MINDVR</p>
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2">
          {values.map((v, i) => (
            <Reveal key={v.tag} delay={(i % 2) * 100}>
              <div className="group h-full rounded-lg border border-ink-line bg-ink p-8 transition-colors hover:border-lime/60">
