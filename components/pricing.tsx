...
const plans = [
  ...
  },
  {
    ...
    price: "별도 협의",
    unit: "",
    desc: "전용 페르소나 구축, 대량 제작, 서비스 연동(API)까지 — 제품 안에 AI 휴먼을 심습니다.",
    features: ["전용 페르소나 · 멀티 캐릭터", "대량 제작 대응", "API · 서비스 연동"],
    cta: "도입 상담",
    highlight: false,
  },
];
    ...
    <section id="pricing" className="border-t border-ink-line bg-ink-soft/40">
      <div className="mx-auto max-w-6xl px-5 py-24 sm:py-32">
        <SectionHeader
          ...
          lede="직접 제작하기 때문에 가능한 구조입니다. 무료 데모로 품질을 확인한 뒤, 물량·프로젝트 단위로만 비용이 발생합니다."
        />
