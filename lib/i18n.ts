...
const ko = {
  ...
  appMeta: {
    testTitle: "테스트 랩 — 마인드브이알 MindVR",
    testDescription: "마인드브이알의 음성·대화·이미지·영상·아바타 생성 기술을 직접 테스트해 보세요.",
    accountTitle: "내 계정 — 마인드브이알 MindVR",
  ...
  testPage: {
    heading: "직접 만들어 보세요.",
    lede: "마인드브이알의 생성 스튜디오에 실시간으로 연결된 테스트 페이지입니다. 음성·대화·이미지·영상·아바타를 직접 만들어 품질을 확인해 보세요. 모든 결과물은 GPU에서 즉석 생성됩니다.",
  },
  adminPage: {
    heading: "관리자",
    lede: "사용자 크레딧 충전, 무제한 권한 부여, 서비스별 사용 로그를 관리합니다.",
  },
  auth: {
    loginHeading: "로그인",
    signupHeading: "회원가입",
    signupLede: "가입하면 {bonus} 크레딧을 무료로 드립니다. 음성·이미지·영상·아바타를 바로 만들어 보세요.",
    name: "이름",
    namePlaceholder: "홍길동",
    email: "이메일",
    password: "비밀번호",
    ...
    processing: "처리 중…",
    signupSubmit: "가입하고 {bonus} 크레딧 받기",
    loginSubmit: "로그인",
...
const en: Dict = {
  ...
  appMeta: {
    testTitle: "Test Lab — MindVR",
    testDescription: "Try MindVR's voice, chat, image, video, and avatar generation yourself.",
    accountTitle: "My account — MindVR",
  ...
  testPage: {
    ...
    lede: "A test page wired live to MindVR's generation studio. Build voice, chat, image, video, and avatar yourself and check the quality. Everything is generated on the spot on GPU.",
  },
  adminPage: {
    heading: "Admin",
    lede: "Manage user credit top-ups, unlimited access grants, and per-service usage logs.",
  },
  auth: {
    loginHeading: "Log in",
    signupHeading: "Sign up",
    signupLede: "Sign up and get {bonus} credits free. Make voice, image, video, and avatar right away.",
    name: "Name",
    ...
    signupSubmit: "Sign up · get {bonus} credits",
    loginSubmit: "Log in",
...
const zh: Dict = {
  ...
  appMeta: {
    testTitle: "体验实验室 — MindVR",
    testDescription: "亲自体验 MindVR 的语音、对话、图像、视频与数字人生成技术。",
    accountTitle: "我的账户 — MindVR",
  ...
  testPage: {
    heading: "亲自做做看。",
    lede: "这是与 MindVR 生成工作室实时连接的体验页面。亲手制作语音、对话、图像、视频与数字人，确认品质。所有成品都在 GPU 上即时生成。",
  },
  adminPage: {
    heading: "管理员",
    lede: "管理用户积分充值、无限权限授予，以及各服务的使用日志。",
  },
  auth: {
    loginHeading: "登录",
    signupHeading: "注册",
    signupLede: "注册即免费获得 {bonus} 积分。立即制作语音、图像、视频与数字人。",
    name: "姓名",
