...
const ko = {
  ...
  accountPanel: {
    ...
    unlimited: "무제한",
    creditsUnit: "크레딧",
    useInLab: "테스트 랩에서 사용하기",
    galleryTitle: "GALLERY · 내 생성물",
    refresh: "새로고침 ↻",
    emptyLead: "아직 생성한 결과물이 없습니다. ",
    testLab: "테스트 랩",
    emptyTail: "에서 이미지·영상·오디오를 만들어 보세요.",
    galleryNote: "* 테스트 랩에서 만든 이미지·영상·음성·음악이 자동으로 모입니다. 방금 만든 결과는 처리가 끝난 뒤 새로고침하면 나타납니다.",
    couponTitle: "COUPON · 쿠폰 등록",
    couponPlaceholder: "쿠폰 코드 입력 (예: WELCOME50)",
    couponChecking: "확인 중…",
    couponSubmit: "등록",
    couponFail: "쿠폰을 사용할 수 없습니다.",
    couponSuccess: "{n} 크레딧이 충전되었습니다!",
    priceTitle: "PRICE · 서비스별 크레딧 단가",
    creditPerRun: "크레딧 / 회",
    rechargeTitle: "RECHARGE · 충전 패키지",
    perCredit: "크레딧당 약 ₩{x}",
    packNote: "* 기준 단가 1크레딧 ≈ ₩{won}. 현재는 결제 연동 전이라 충전은 쿠폰 또는 관리자에게 문의해 주세요.",
    historyTitle: "HISTORY · 내 사용 내역",
    thTime: "시각", thType: "구분", thService: "서비스", thCredits: "크레딧", thBalance: "잔액",
    noHistory: "아직 사용 내역이 없습니다.",
    cumulative: "누적: ",
    usageUnit: "회",
    typeLabels: { signup_bonus: "가입 보너스", spend: "사용", grant: "충전", refund: "환불", coupon: "쿠폰" },
    kindLabels: { image: "이미지", video: "영상", audio: "오디오" },
    creationErr: "처리 중이거나 만료된 결과입니다",
    creationAlt: "생성 이미지",
    save: "저장",
  },
  admin: {
    loading: "로딩 중…",
    usageTitle: "SERVICE USAGE · 서비스별 소모",
    usageCount: "{n}회 · 크레딧",
    usersTitle: "USERS · 사용자 {n}명",
    thNameEmail: "이름 · 이메일", thBalance: "잔액", thSpent: "누적 소모", thUnlimited: "무제한", thJoined: "가입일", thManage: "관리",
    viewUserLogs: "이 사용자 로그 보기",
    unlimited: "무제한",
    grantBtn: "크레딧 충전",
    grantPrompt: "충전할 크레딧 (차감은 음수, 예: 1000 또는 -500)",
    grantFail: "실패",
    logsTitle: "LOGS · 사용 로그",
    filtered: "(필터됨)",
    viewAll: "전체 보기",
    thTime: "시각", thUser: "사용자", thType: "구분", thService: "서비스", thCredits: "크레딧",
    noLogs: "로그가 없습니다.",
    typeLabels: { signup_bonus: "가입 보너스", spend: "사용", grant: "충전", refund: "환불", coupon: "쿠폰" },
    coupons: {
      title: "COUPONS · 쿠폰 {n}개",
      codeLabel: "코드(빈칸=자동)", creditsLabel: "지급 크레딧 *", maxLabel: "최대 사용(빈칸=무제한)", expiresLabel: "만료일(선택)", noteLabel: "메모(선택)",
      notePlaceholder: "신규 가입 프로모션",
      createBtn: "쿠폰 생성", createFail: "생성 실패",
      thCode: "코드", thCredits: "크레딧", thUses: "사용/한도", thExpiry: "만료", thStatus: "상태", thManage: "관리",
      active: "활성", expired: "만료", exhausted: "소진", stopped: "중지",
      expiredTitle: "만료됨", exhaustedTitle: "소진됨", stoppedTitle: "중지됨",
      deleteBtn: "삭제", deleteConfirm: "쿠폰 {code} 을(를) 삭제할까요? (지급 이력은 유지됩니다)",
      noCoupons: "생성된 쿠폰이 없습니다.", noExpiry: "무기한",
    },
  },
  lab: {
    estimate: { llm: "보통 몇 초", tts: "보통 10~60초", image: "보통 30초~2분", video: "보통 수 분", avatar: "보통 수 분", music: "보통 1~3분" },
    generating: "생성 중…",
    attachedAlt: "첨부 이미지",
    remove: "제거",
    choosePhoto: "사진 선택 (JPG·PNG)",
    jobDone: "{s} 생성이 완료됐어요!",
    jobFailed: "생성에 실패했어요. 크레딧은 환불됐습니다.",
    insufficient: "크레딧이 부족합니다.",
    insufficientToast: "크레딧이 부족합니다. 충전 후 이용해 주세요.",
    requestFailed: "요청에 실패했습니다.",
    jobStarted: "{s} 생성을 시작했어요",
    jobStartedCharged: "{s} 생성 시작 · {c} 크레딧 사용",
    requestError: "요청 중 오류가 발생했습니다.",
    cancelled: "{s} 생성을 취소했어요. 크레딧을 환불했습니다.",
    cancelError: "취소 요청 중 오류가 발생했습니다.",
    progressSubmitting: "요청을 보내는 중…",
    progressQueued: "대기열에서 순서를 기다리고 있어요",
    progressWorking: "AI가 열심히 만들고 있어요",
    queuedSub: "GPU가 비는 대로 자동으로 시작됩니다",
    workingSub: "{est} 걸려요 · 다른 페이지로 이동해도 계속 진행됩니다",
    cancel: "취소",
    doneHeader: "생성 완료",
    viewLarge: "크게 보기",
    download: "다운로드",
    resultAlt: "생성 결과",
    resultFileDownload: "결과 파일 다운로드",
    resultZoomAlt: "생성 결과 크게 보기",
    close: "닫기 ✕",
    chargeInfo: "충전 안내",
    ttsDefault: "안녕하세요, 마인드브이알입니다. 이 음성은 방금 만들어졌습니다.",
    ttsPlaceholder: "읽을 한국어 문장",
    defaultVoice: "기본 음성",
    ttsGenerate: "음성 생성",
    chatExamples: ["마인드브이알을 한 문장으로 소개해줘.", "AI 휴먼으로 뭘 만들 수 있어?", "30대 한국 여성 이미지 만들어줘"],
    chatStartedReply: "생성을 시작했어요. 잠시만 기다려 주세요.",
    chatNoReply: "응답을 받지 못했습니다.",
    chatHeader: "대화형 AI · 메시지당 {c} CR",
    clearChat: "대화 지우기",
    chatEmpty: "무엇이든 물어보세요. 대화 맥락을 기억합니다.",
    typing: "입력 중…",
    chatPlaceholder: "메시지를 입력하세요 (Enter 전송 · Shift+Enter 줄바꿈)",
    send: "보내기",
    chatNote: "* \u201c~만들어줘\u201d라고 하면 실제 생성 잡이 시작될 수 있습니다. 결과물은 내 갤러리에서 확인하세요.",
    compareDone: "이미지 생성이 완료됐어요!",
    compareStart: "이미지 {n}장 생성 시작",
    compareStartCharged: "이미지 {n}장 생성 시작 · {c} 크레딧 사용",
    genFailed: "생성 실패",
    imageN: "이미지 {n}",
    save: "저장",
    imgDefault: "밝은 스튜디오에서 카메라를 보고 미소 짓는 바리스타",
    gen4: "이미지 4장 생성",
    imgNoteA: "* 한 번에 ", imgNoteEm1: "4개 AI 모델이 각 1장씩", imgNoteB: " 생성합니다. 마음에 드는 결과를 골라 저장하세요. 국적을 따로 적지 않으면 ", imgNoteEm2: "한국인·한국 배경", imgNoteC: "으로 자동 생성됩니다.",
    comparing: "이미지 4장을 동시에 만드는 중…",
    videoDefault: "햇살 좋은 한강공원에서 강아지와 산책하는 사람, 시네마틱",
    videoPlaceholder: "만들고 싶은 영상을 설명하세요",
    videoStartImage: "시작 이미지 (선택) — 첨부하면 그 이미지가 움직이는 영상으로 만듭니다",
    videoGenImage: "이미지로 영상 생성 (5초)",
    videoGen: "영상 생성 (5초)",
    avatarSamples: ["프레젠터", "상담사", "면접관", "인플루언서", "디지털트윈"],
    avatarDefault: "안녕하세요! 이 영상은 테스트 페이지에서 방금 만들어졌습니다.",
    avatarPlaceholder: "아바타가 말할 한국어 대사",
    personSelect: "인물 선택",
    avatarUpload: "또는 내 사진 첨부 — 첨부한 인물이 말하는 영상으로 만듭니다",
    avatarGen: "말하는 아바타 생성 (6초)",
    genres: ["자동", "어쿠스틱", "팝", "발라드", "재즈", "Lo-Fi", "일렉트로닉", "시네마틱", "클래식", "힙합", "R&B", "록", "트로트"],
    moods: ["자동", "밝은", "차분한", "감성적인", "신나는", "웅장한", "슬픈", "몽환적인"],
    musicDefault: "잔잔한 카페에서 어울리는 따뜻한 어쿠스틱 음악",
    musicPlaceholder: "만들고 싶은 음악을 설명하세요 (분위기·장면·악기 등)",
    genreLabel: "장르", moodLabel: "분위기", lengthLabel: "길이",
    secondsUnit: "{d}초",
    instrumental: "연주곡 (보컬 없음)",
    lyricsPlaceholder: "가사 (선택) — 비워두면 분위기에 맞춰 자동 작사됩니다",
    musicGen: "음악 생성",
    loading: "불러오는 중…",
    loginRequired: "로그인이 필요합니다",
    gateLede: "회원가입하면 {bonus} 크레딧을 무료로 드립니다. 음성·이미지·영상·아바타를 직접 만들어 보세요.",
    gateSignup: "회원가입 ({bonus} 크레딧)",
    gateLogin: "로그인",
    userSuffix: "님 · ",
    unlimitedUse: "무제한 사용",
    balanceLead: "잔액 ", creditsUnit: "크레딧",
    usageLink: "사용 내역 · 충전 →",
    queueLabel: "대기열 {n}",
  },
  nav: {
...
const en: Dict = {
  ...
  accountPanel: {
    ...
    unlimited: "Unlimited",
    creditsUnit: "credits",
    useInLab: "Use in the Test Lab",
    galleryTitle: "GALLERY · My creations",
    refresh: "Refresh ↻",
    emptyLead: "You haven't created anything yet. Make images, videos, and audio in the ",
    testLab: "Test Lab",
    emptyTail: ".",
    galleryNote: "* Images, videos, voice, and music made in the Test Lab collect here automatically. A just-made result appears once it finishes — hit refresh.",
    couponTitle: "COUPON · Redeem",
    couponPlaceholder: "Enter coupon code (e.g. WELCOME50)",
    couponChecking: "Checking…",
    couponSubmit: "Redeem",
    couponFail: "This coupon can't be used.",
    couponSuccess: "{n} credits added!",
    priceTitle: "PRICE · Credit cost per service",
    creditPerRun: "credits / run",
    rechargeTitle: "RECHARGE · Credit packs",
    perCredit: "≈ ₩{x} per credit",
    packNote: "* Base rate: 1 credit ≈ ₩{won}. Payments aren't integrated yet — top up via coupon or contact an admin.",
    historyTitle: "HISTORY · My usage",
    thTime: "Time", thType: "Type", thService: "Service", thCredits: "Credits", thBalance: "Balance",
    noHistory: "No usage yet.",
    cumulative: "Total: ",
    usageUnit: "\u00d7",
    typeLabels: { signup_bonus: "Signup bonus", spend: "Spent", grant: "Top-up", refund: "Refund", coupon: "Coupon" },
    kindLabels: { image: "Image", video: "Video", audio: "Audio" },
    creationErr: "Processing or expired result",
    creationAlt: "Generated image",
    save: "Save",
  },
  admin: {
    loading: "Loading…",
    usageTitle: "SERVICE USAGE · Per service",
    usageCount: "{n}\u00d7 · credits",
    usersTitle: "USERS · {n} users",
    thNameEmail: "Name · Email", thBalance: "Balance", thSpent: "Total spent", thUnlimited: "Unlimited", thJoined: "Joined", thManage: "Manage",
    viewUserLogs: "View this user's logs",
    unlimited: "Unlimited",
    grantBtn: "Add credits",
    grantPrompt: "Credits to add (negative to deduct, e.g. 1000 or -500)",
    grantFail: "Failed",
    logsTitle: "LOGS · Usage logs",
    filtered: "(filtered)",
    viewAll: "View all",
    thTime: "Time", thUser: "User", thType: "Type", thService: "Service", thCredits: "Credits",
    noLogs: "No logs.",
    typeLabels: { signup_bonus: "Signup bonus", spend: "Spent", grant: "Top-up", refund: "Refund", coupon: "Coupon" },
    coupons: {
      title: "COUPONS · {n} coupons",
      codeLabel: "Code (blank = auto)", creditsLabel: "Credits *", maxLabel: "Max uses (blank = unlimited)", expiresLabel: "Expiry (optional)", noteLabel: "Note (optional)",
      notePlaceholder: "New-signup promo",
      createBtn: "Create coupon", createFail: "Creation failed",
      thCode: "Code", thCredits: "Credits", thUses: "Uses/Limit", thExpiry: "Expiry", thStatus: "Status", thManage: "Manage",
      active: "Active", expired: "Expired", exhausted: "Used up", stopped: "Stopped",
      expiredTitle: "Expired", exhaustedTitle: "Used up", stoppedTitle: "Stopped",
      deleteBtn: "Delete", deleteConfirm: "Delete coupon {code}? (Redemption history is kept.)",
      noCoupons: "No coupons yet.", noExpiry: "No expiry",
    },
  },
  lab: {
    estimate: { llm: "usually a few seconds", tts: "usually 10–60s", image: "usually 30s–2min", video: "usually a few minutes", avatar: "usually a few minutes", music: "usually 1–3min" },
    generating: "Generating…",
    attachedAlt: "Attached image",
    remove: "Remove",
    choosePhoto: "Choose photo (JPG·PNG)",
    jobDone: "{s} is ready!",
    jobFailed: "Generation failed. Your credits were refunded.",
    insufficient: "Not enough credits.",
    insufficientToast: "Not enough credits. Please top up to continue.",
    requestFailed: "Request failed.",
    jobStarted: "Started generating {s}",
    jobStartedCharged: "Started {s} · {c} credits used",
    requestError: "An error occurred during the request.",
    cancelled: "{s} generation cancelled. Credits refunded.",
    cancelError: "An error occurred while cancelling.",
    progressSubmitting: "Sending request…",
    progressQueued: "Waiting your turn in the queue",
    progressWorking: "The AI is hard at work",
    queuedSub: "Starts automatically as soon as a GPU frees up",
    workingSub: "Takes {est} · keeps going even if you navigate away",
    cancel: "Cancel",
    doneHeader: "Done",
    viewLarge: "View large",
    download: "Download",
    resultAlt: "Generated result",
    resultFileDownload: "Download result file",
    resultZoomAlt: "Generated result, enlarged",
    close: "Close ✕",
    chargeInfo: "Top-up info",
    ttsDefault: "Hello, this is MindVR. This voice was just generated.",
    ttsPlaceholder: "Text to read aloud",
    defaultVoice: "Default voice",
    ttsGenerate: "Generate voice",
    chatExamples: ["Introduce MindVR in one sentence.", "What can I make with AI humans?", "Make an image of a Korean woman in her 30s"],
    chatStartedReply: "Started generating. Please wait a moment.",
    chatNoReply: "No response received.",
    chatHeader: "Conversational AI · {c} CR per message",
    clearChat: "Clear chat",
    chatEmpty: "Ask anything. It remembers the conversation.",
    typing: "Typing…",
    chatPlaceholder: "Type a message (Enter to send · Shift+Enter for newline)",
    send: "Send",
    chatNote: "* Saying \u201cmake me ~\u201d may start a real generation job. Find the results in My creations.",
    compareDone: "Images are ready!",
    compareStart: "Generating {n} images",
    compareStartCharged: "Generating {n} images · {c} credits used",
    genFailed: "Failed",
    imageN: "Image {n}",
    save: "Save",
    imgDefault: "A barista smiling at the camera in a bright studio",
    gen4: "Generate 4 images",
    imgNoteA: "* ", imgNoteEm1: "4 AI models each make one image", imgNoteB: " at once. Pick your favorite and save it. If you don't specify a nationality, ", imgNoteEm2: "Korean people · Korean settings", imgNoteC: " are generated by default.",
    comparing: "Making 4 images at once…",
    videoDefault: "Someone walking a dog at a sunny riverside park, cinematic",
    videoPlaceholder: "Describe the video you want",
    videoStartImage: "Start image (optional) — attach one to animate it into a video",
    videoGenImage: "Generate video from image (5s)",
    videoGen: "Generate video (5s)",
    avatarSamples: ["Presenter", "Counselor", "Interviewer", "Influencer", "Digital Twin"],
    avatarDefault: "Hi! This video was just made on the test page.",
    avatarPlaceholder: "Lines for the avatar to speak",
    personSelect: "Choose a person",
    avatarUpload: "Or attach your own photo — the attached person becomes the speaker",
    avatarGen: "Generate talking avatar (6s)",
    genres: ["Auto", "Acoustic", "Pop", "Ballad", "Jazz", "Lo-Fi", "Electronic", "Cinematic", "Classical", "Hip-hop", "R&B", "Rock", "Trot"],
    moods: ["Auto", "Bright", "Calm", "Emotional", "Upbeat", "Epic", "Sad", "Dreamy"],
    musicDefault: "Warm acoustic music that suits a quiet cafe",
    musicPlaceholder: "Describe the music you want (mood, scene, instruments, etc.)",
    genreLabel: "Genre", moodLabel: "Mood", lengthLabel: "Length",
    secondsUnit: "{d}s",
    instrumental: "Instrumental (no vocals)",
    lyricsPlaceholder: "Lyrics (optional) — leave blank to auto-write to the mood",
    musicGen: "Generate music",
    loading: "Loading…",
    loginRequired: "Login required",
    gateLede: "Sign up and get {bonus} credits free. Make voice, image, video, and avatar yourself.",
    gateSignup: "Sign up ({bonus} credits)",
    gateLogin: "Log in",
    userSuffix: " · ",
    unlimitedUse: "Unlimited use",
    balanceLead: "Balance ", creditsUnit: "credits",
    usageLink: "Usage · Top up →",
    queueLabel: "Queue {n}",
  },
  nav: {
...
const zh: Dict = {
  ...
  accountPanel: {
    ...
    creditsUnit: "积分",
    useInLab: "在体验实验室使用",
    galleryTitle: "GALLERY · 我的作品",
    refresh: "刷新 ↻",
    emptyLead: "还没有任何作品。去",
    testLab: "体验实验室",
    emptyTail: "制作图像、视频与音频吧。",
    galleryNote: "* 在体验实验室制作的图像、视频、语音与音乐会自动汇集到这里。刚生成的结果在处理完成后，刷新即可显示。",
    couponTitle: "COUPON · 兑换优惠券",
    couponPlaceholder: "输入优惠券代码（如 WELCOME50）",
    couponChecking: "验证中…",
    couponSubmit: "兑换",
    couponFail: "该优惠券无法使用。",
    couponSuccess: "已充值 {n} 积分！",
    priceTitle: "PRICE · 各服务积分单价",
    creditPerRun: "积分 / 次",
    rechargeTitle: "RECHARGE · 充值套餐",
    perCredit: "约 ₩{x} / 积分",
    packNote: "* 基准单价 1 积分 ≈ ₩{won}。目前尚未接入支付，充值请使用优惠券或联系管理员。",
    historyTitle: "HISTORY · 我的使用记录",
    thTime: "时间", thType: "类型", thService: "服务", thCredits: "积分", thBalance: "余额",
    noHistory: "暂无使用记录。",
    cumulative: "累计： ",
    usageUnit: " 次",
    typeLabels: { signup_bonus: "注册赠送", spend: "消费", grant: "充值", refund: "退款", coupon: "优惠券" },
    kindLabels: { image: "图像", video: "视频", audio: "音频" },
    creationErr: "处理中或已过期的结果",
    creationAlt: "生成图像",
    save: "保存",
  },
  admin: {
    loading: "加载中…",
    usageTitle: "SERVICE USAGE · 各服务消耗",
    usageCount: "{n} 次 · 积分",
    usersTitle: "USERS · {n} 位用户",
    thNameEmail: "姓名 · 邮箱", thBalance: "余额", thSpent: "累计消耗", thUnlimited: "无限", thJoined: "注册日", thManage: "管理",
    viewUserLogs: "查看该用户日志",
    unlimited: "无限",
    grantBtn: "充值积分",
    grantPrompt: "要充值的积分（扣除用负数，如 1000 或 -500）",
    grantFail: "失败",
    logsTitle: "LOGS · 使用日志",
    filtered: "（已筛选）",
    viewAll: "查看全部",
    thTime: "时间", thUser: "用户", thType: "类型", thService: "服务", thCredits: "积分",
    noLogs: "暂无日志。",
    typeLabels: { signup_bonus: "注册赠送", spend: "消费", grant: "充值", refund: "退款", coupon: "优惠券" },
    coupons: {
      title: "COUPONS · {n} 张优惠券",
      codeLabel: "代码（留空=自动）", creditsLabel: "赠送积分 *", maxLabel: "最大使用次数（留空=无限）", expiresLabel: "到期日（可选）", noteLabel: "备注（可选）",
      notePlaceholder: "新用户促销",
      createBtn: "创建优惠券", createFail: "创建失败",
      thCode: "代码", thCredits: "积分", thUses: "使用/上限", thExpiry: "到期", thStatus: "状态", thManage: "管理",
      active: "启用", expired: "已过期", exhausted: "已用完", stopped: "已停用",
      expiredTitle: "已过期", exhaustedTitle: "已用完", stoppedTitle: "已停用",
      deleteBtn: "删除", deleteConfirm: "删除优惠券 {code}？（兑换记录将保留。）",
      noCoupons: "暂无优惠券。", noExpiry: "无限期",
    },
  },
  lab: {
    estimate: { llm: "通常几秒", tts: "通常 10–60 秒", image: "通常 30 秒–2 分钟", video: "通常几分钟", avatar: "通常几分钟", music: "通常 1–3 分钟" },
    generating: "生成中…",
    attachedAlt: "附加图片",
    remove: "移除",
    choosePhoto: "选择照片（JPG·PNG）",
    jobDone: "{s} 已完成！",
    jobFailed: "生成失败。积分已退还。",
    insufficient: "积分不足。",
    insufficientToast: "积分不足。请充值后再使用。",
    requestFailed: "请求失败。",
    jobStarted: "已开始生成 {s}",
    jobStartedCharged: "开始生成 {s} · 已用 {c} 积分",
    requestError: "请求过程中出错。",
    cancelled: "已取消 {s} 生成。积分已退还。",
    cancelError: "取消请求时出错。",
    progressSubmitting: "正在发送请求…",
    progressQueued: "正在队列中等待",
    progressWorking: "AI 正在努力制作",
    queuedSub: "GPU 一空闲就会自动开始",
    workingSub: "{est} · 即使切换到其他页面也会继续进行",
    cancel: "取消",
    doneHeader: "已完成",
    viewLarge: "放大查看",
    download: "下载",
    resultAlt: "生成结果",
    resultFileDownload: "下载结果文件",
    resultZoomAlt: "放大的生成结果",
    close: "关闭 ✕",
    chargeInfo: "充值说明",
    ttsDefault: "您好，这里是 MindVR。这段语音刚刚生成。",
    ttsPlaceholder: "要朗读的文字",
    defaultVoice: "默认语音",
    ttsGenerate: "生成语音",
    chatExamples: ["用一句话介绍 MindVR。", "用 AI 数字人能做什么？", "生成一张 30 多岁韩国女性的图片"],
    chatStartedReply: "已开始生成，请稍候。",
    chatNoReply: "未收到回复。",
    chatHeader: "对话式 AI · 每条消息 {c} CR",
    clearChat: "清空对话",
    chatEmpty: "随便问。它会记住对话上下文。",
    typing: "正在输入…",
    chatPlaceholder: "输入消息（Enter 发送 · Shift+Enter 换行）",
    send: "发送",
    chatNote: "* 说\u201c帮我做~\u201d可能会启动真实的生成任务。结果可在我的作品中查看。",
    compareDone: "图片已完成！",
    compareStart: "开始生成 {n} 张图片",
    compareStartCharged: "开始生成 {n} 张图片 · 已用 {c} 积分",
    genFailed: "生成失败",
    imageN: "图片 {n}",
    save: "保存",
    imgDefault: "在明亮的工作室里对着镜头微笑的咖啡师",
    gen4: "生成 4 张图片",
    imgNoteA: "* 一次由 ", imgNoteEm1: "4 个 AI 模型各生成 1 张", imgNoteB: "。挑选喜欢的保存即可。若不特别注明国籍，", imgNoteEm2: "默认生成韩国人·韩国场景", imgNoteC: "。",
    comparing: "正在同时制作 4 张图片…",
    videoDefault: "阳光明媚的江边公园里遛狗的人，电影感",
    videoPlaceholder: "描述你想要的视频",
    videoStartImage: "起始图片（可选）——附加后会让该图片动起来生成视频",
    videoGenImage: "用图片生成视频（5 秒）",
    videoGen: "生成视频（5 秒）",
    avatarSamples: ["主持人", "咨询师", "面试官", "网红", "数字分身"],
    avatarDefault: "您好！这段视频刚刚在体验页面生成。",
    avatarPlaceholder: "数字人要说的台词",
    personSelect: "选择人物",
    avatarUpload: "或附加我的照片——附加的人物将成为说话者",
    avatarGen: "生成会说话的数字人（6 秒）",
    genres: ["自动", "原声", "流行", "抒情", "爵士", "Lo-Fi", "电子", "电影感", "古典", "嘻哈", "R&B", "摇滚", "Trot"],
    moods: ["自动", "明亮", "舒缓", "感性", "欢快", "宏大", "悲伤", "梦幻"],
    musicDefault: "适合安静咖啡馆的温暖原声音乐",
    musicPlaceholder: "描述你想要的音乐（氛围、场景、乐器等）",
    genreLabel: "风格", moodLabel: "氛围", lengthLabel: "时长",
    secondsUnit: "{d} 秒",
    instrumental: "纯音乐（无人声）",
    lyricsPlaceholder: "歌词（可选）——留空则按氛围自动作词",
    musicGen: "生成音乐",
    loading: "加载中…",
    loginRequired: "需要登录",
    gateLede: "注册即免费获得 {bonus} 积分。亲手制作语音、图像、视频与数字人。",
    gateSignup: "注册（{bonus} 积分）",
    gateLogin: "登录",
    userSuffix: " · ",
    unlimitedUse: "无限使用",
    balanceLead: "余额 ", creditsUnit: "积分",
    usageLink: "使用记录 · 充值 →",
    queueLabel: "队列 {n}",
  },
  nav: {
